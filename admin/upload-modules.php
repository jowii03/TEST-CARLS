                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                       ...
                       <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <li class="nav-item">
                                    <a href="upload-modules.php" class="nav-link menu-active "><i class="fas fa-angle-right"></i>Modules</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label">#<?php echo $row["module_id"]; ?></label>
                                            </div>
                                        </td>
                                        <td class="text-center"><img src="img/<?php echo $row["module_photo"]; ?>" class="module-img" alt="#"></td>
                                        <td><?php echo $row["module_name"]; ?></td>
                                        <td><a href="modules/<?php echo $row["module_file"]; ?>"><?php echo $row["module_file"]; ?></a></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                	<a class="dropdown-item btnupdate" id="<?php echo $row["module_id"]; ?>" mn="<?php echo $row["module_name"]; ?>"><i
                                                            class="fas fa-edit text-dark-pastel-green"></i>Edit</a>
                                                    <a class="dropdown-item btndelete" id="<?php echo $row["module_id"]; ?>"><i
 							...
 							<form class="" id="frmModuleEdit">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                     ...
                                     <div class="col-xl-12 col-lg-12 col-12 form-group">
                                         ...
                                         <input type="text" id="mName" name="mName" placeholder="Update Module Name" class="form-control" style="border: .5px solid #5A6375;margin-top: -20px;" required="">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                         ...
                                         <input type="file" id="mFile" name="mFile"  placeholder="" class="form-control" style="height: 5rem;padding: 1.2rem;border: .5px solid #5A6375;margin-top: -20px;" required="">
                                    </div>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="padding: 2rem;">
                  ...
                  <div class="modal-body">
 							...
 							<form class="" id="frmModuleAdd">
                                
                                

                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                         <label>Module Photo</label>
                                         <input type="file" id="image2" name="image2" placeholder="" class="form-control" style="height: 5rem;padding: 1.2rem;border: .5px solid #5A6375;margin-top: -20px;" required="">
                                    </div>

                                     <div class="col-xl-12 col-lg-12 col-12 form-group">
                                         <label>Module Name</label>
                                         <input type="text" id="amName" name="amName" placeholder="Enter Module Name" class="form-control" style="border: .5px solid #5A6375;margin-top: -20px;" required="">
                                    </div>

                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                         <label>Module File</label>
                                         <input type="file" id="amFile" name="amFile"  placeholder="" class="form-control" style="height: 5rem;padding: 1.2rem;border: .5px solid #5A6375;margin-top: -20px;" required="">
                                         <input type="hidden" name="action" id="action" value="insertModule">
                                    </div>
