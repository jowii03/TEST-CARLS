                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                       <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="assesment-viewer.php" class="nav-link  menu-active"><i class="flaticon-maths-class-materials-cross-of-a-pencil-and-a-ruler"></i><span>Assesment Viewer</span></a>
                        </li>
                        <li class="nav-item">
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php
                                      ...
                                      {
                                        $sql2 = "SELECT * FROM users_info WHERE user_info_id = ".$row['user_info_id']."";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($row["assessment_score"]/20)*100; ?>%</td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item btnview" id="<?php echo $row["user_info_id"]; ?>" 
                                                    srcOfImg="img/figure/<?php echo $row2["user_photo"]; ?>"
                                                    fn="<?php echo $row2["user_lastname"]." ".$row2["user_firstname"]." ".$row2["user_middlename"]; ?>"
                                                    ad="<?php echo $row["assessment_date"]; ?>"
                                                    as="<?php echo $row["assessment_score"]; ?>"
                                                    asp="<?php echo ($row["assessment_score"]/20)*100; ?>"
                                                ><i
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="padding: 2rem;">
                  <div class="modal-header">
                     <h2 class="modal-title">Assesment Details:<span></span></h2>
                        ...
                        <div class=" account-settings-box">
                                ...
                                <div class="user-details-box">
                                    <div class="item-img" style="text-align: center;">
                                        <img id="avatar" name="avatar" src="img/figure/user.jpg" alt="user" style="width: 15rem;" >
                                    </div>
                                    <div class="item-content">
                                        <div class="info-table table-responsive" style="margin-top: -20px;">
                                            <table class="table text-nowrap">
                                                <tbody>
                                                    <tr>
                                                        <td>Name:</td>
                                                        <td id="fullName" name="fullName"  class="font-small text-dark-medium">Joser Palmon Rizal</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Score:</td>
                                                        <td id="aScore" name="aScore" class="font-small text-dark-medium">50</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Percentage:</td>
                                                        <td id="aScoreP" name="aScoreP" class="font-small text-dark-medium">100%</td>
                                                    </tr>
                                                     <tr>
                                                        <td>Date:</td>
                                                        <td id="aDate" name="aDate" class="font-small text-dark-medium">11/22/20</td>
                                                    </tr>
...
<script type="text/javascript">
    ...
    //Update//
       $(document).on('click', '.btnview', function(){
        ...
        $('#aDate').text($(this).attr('ad'));
        $('#aScore').text($(this).attr('as'));
        $('#aScoreP').text($(this).attr('asp'));
